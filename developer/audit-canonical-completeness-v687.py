...
OUT_AUDIT=ROOT/'data/canonical-completeness-audit-v6.87.json'
OUT_QUEUE=ROOT/'data/canonical-missing-data-queue-v6.87.json'
...
summary={
 'release':'v6.87.0','generatedAt':datetime.datetime.now(datetime.timezone.utc).isoformat(),'modelCount':len(models),'registeredFieldCount':len(fields),
...
queue={
 'release':'v6.87.0','generatedAt':summary['generatedAt'],'modelCount':len(models),
